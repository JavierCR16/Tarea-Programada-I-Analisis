...
\documentclass[conference]{C:/Program Files (x86)/MiKTeX 2.9/tex/latex/ltxmisc/IEEEtran}
...
\title{Proyecto Van Gogh Evolucional\\ Análisis de Algoritmos}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Javier Contreras Muñoz}
...
% make the title area
\maketitle{Algoritmos Genéticos} 
